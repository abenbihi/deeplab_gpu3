...
#######################################
SAVE_DIR=${ROOT_DIR}/exper/${DATASET}/res/${FEATURE_NAME}/${MODEL_NAME}/${TEST_SET}/${FEATURE_TYPE}/63/post_densecrf_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}
...
then
    ...
    FEATURE_DIR=/home/gpu_user/assia/ws/datasets/antoine/features/63000
else
