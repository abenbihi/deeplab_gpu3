#ifndef CAFFE_SOFTMAX_WITH_LOSS_LAYER_WEIGHTS_HPP_
#define CAFFE_SOFTMAX_WITH_LOSS_LAYER_WEIGHTS_HPP_
...
class SoftmaxWithLossWeightsLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithLossWeightsLayer(const LayerParameter& param)
...
#endif  // CAFFE_SOFTMAX_WITH_LOSS_LAYER_WEIGHTS_HPP_
