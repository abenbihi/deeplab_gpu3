...
#include "caffe/layers/softmax_loss_weights_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
Dtype SoftmaxWithLossWeightsLayer<Dtype>::get_normalizer(
...
template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SoftmaxWithLossWeightsLayer);
#endif

INSTANTIATE_CLASS(SoftmaxWithLossWeightsLayer);
REGISTER_LAYER_CLASS(SoftmaxWithLossWeights);
