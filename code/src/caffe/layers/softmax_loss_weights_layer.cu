...
template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::Forward_gpu(
...
template <typename Dtype>
void SoftmaxWithLossWeightsLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(SoftmaxWithLossWeightsLayer);
